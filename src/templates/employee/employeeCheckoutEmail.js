const getEmployeeCheckoutReminderEmail = (employeeName, schoolName, category, scheduledEndTime) => {
    return `
        ...
        .badge { display: inline-block; padding: 6px 14px; border-radius: 6px; font-weight: 700; font-size: 13px; letter-spacing: 0.5px; margin-bottom: 24px; text-transform: uppercase; background: #e0e7ff; color: #4338ca; border: 1px solid #c7d2fe; }
        ...
        .card { background-color: #fafafa; padding: 24px; border-radius: 8px; border: 1px solid #e4e4e7; border-left: 4px solid #4338ca; }
        ...
        @media (prefers-color-scheme: dark) {
            ...
            .card { background-color: #09090b !important; border-color: #27272a !important; border-left-color: #4338ca !important; }
            .badge { background: transparent !important; }
        }
        </style></head><body>
        <div class="container"><div class="badge">Action Required</div>
        <h2>Forgot to Check Out?</h2>
        <p>Hello ${employeeName},</p>
        <p>Your scheduled shift ended 10 minutes ago, but our system shows that you are still clocked in. If you have finished your duties, please log in to your dashboard and complete your check-out.</p>
        <div class="card">
        ...
        <p style="margin-top: 24px;">If you are currently working approved overtime, you can safely ignore this reminder and check out when you are finished.</p>
        </div></body></html>
    `;
};
module.exports = getEmployeeCheckoutReminderEmail;