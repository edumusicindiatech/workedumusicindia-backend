const getAdminAssignmentUpdatedTemplate = (adminName, employeeName, schoolName, schoolAddress, category) => `
    ...
    <h2>Staff Schedule Modified</h2><p>Hello ${adminName},</p><p>The following employee's assignment has been updated in the system:</p>
    <div class="card">
...
module.exports = getAdminAssignmentUpdatedTemplate;