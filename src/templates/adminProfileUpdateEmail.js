const getAdminProfileUpdatedTemplate = (adminName, targetName, changedBy) => `
    ...
    <div class="container"><div class="badge">Security Audit Log</div>
    <h2>Profile Information Updated</h2><p>Hello ${adminName},</p><p>This is an automated audit notification. A user profile has been modified by an administrator:</p>
    <div class="card">
        <div class="card-item"><span class="label">Target User</span><div class="value">${targetName}</div></div>
        <div class="card-item"><span class="label">Action Performed By</span><div class="value">${changedBy}</div></div>
        <div class="card-item"><span class="label">Event Type</span><div class="value">Administrative Profile Update</div></div>
    </div>
    <p style="font-size: 12px; color: #a1a1aa; margin-top: 30px;">This log is generated for security compliance and tracking purposes.</p>
    </div></body></html>
`;

module.exports = getAdminProfileUpdatedTemplate;