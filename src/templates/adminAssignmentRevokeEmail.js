const getAdminAssignmentRevokedTemplate = (adminName, employeeName, schoolName, schoolAddress, category) => `
    ...
    <h2>Staff Assignment Revoked</h2><p>Hello ${adminName},</p><p>An assignment has been completely removed from the system:</p>
    <div class="card">
...
module.exports = getAdminAssignmentRevokedTemplate;