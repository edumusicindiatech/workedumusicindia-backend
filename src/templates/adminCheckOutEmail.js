const getAdminCheckOutEmailTemplate = (adminName, employeeName, schoolName, category, checkOutTime, overtimeReason) => {
    const isOvertime = !!overtimeReason;
    const badgeClass = isOvertime ? 'badge-warning' : 'badge-info';
    const badgeText = isOvertime ? 'Overtime Logged' : 'Check-Out Logged';
    const borderColor = isOvertime ? '#f59e0b' : '#3b82f6';
    ...
    @media (prefers-color-scheme: dark) {
        ...
        .badge-info { background: rgba(59, 130, 246, 0.1) !important; color: #60a5fa !important; border-color: rgba(59, 130, 246, 0.2) !important; }
    ...
    <h2>Shift Completed</h2><p>Hello ${adminName},</p><p><strong>${employeeName}</strong> has checked out and completed their visit.</p>
    <div class="card">
...
module.exports = getAdminCheckOutEmailTemplate;