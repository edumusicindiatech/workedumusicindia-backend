const getAdminAutoAbsentEmailTemplate = (adminName, employeeName, schoolName, category, scheduledTime) => {
    return `
    ...
    <p class="footer-text">This action was performed automatically by the Compliance Cron Job.</p>
    </div></body></html>
    `;
};
module.exports = getAdminAutoAbsentEmailTemplate;